        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RamRom = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Mobiles",
                columns: new[] { "Id", "Black", "Blue", "BrandName", "CreatedBy", "CreatedDateUtc", "Model", "Picture", "Price", "RamRom", "Red", "UpdatedBy", "UpdatedDateUtc" },
                values: new object[] { 1L, true, true, "Samsung", 1L, new DateTimeOffset(new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 0, 0, 0)), "A71", "avatar2.png", 29000.0, "8 GB & 128 GB", true, null, null });

            migrationBuilder.InsertData(
                table: "Registrations",
                columns: new[] { "Id", "Address", "CreatedBy", "CreatedDateUtc", "Email", "Name", "Phone", "UpdatedBy", "UpdatedDateUtc" },
                values: new object[] { 1L, "Dhaka", 1L, new DateTimeOffset(new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 0, 0, 0)), "Nabila@gmail.com", "Nabila", "0170000000", null, null });
